...
func main() {
	...
	allContactsOfUser := staff2.GetAllUserContacts()
	fmt.Println("===== All Contacts of specific Users =====")
	if len(allContactsOfUser) == 0 {
		fmt.Println("No contacts found.")
	} else {
		for _, c := range allContactsOfUser {
			fmt.Printf("ContactID: %d, Name: %s %s, IsActive: %t\n", c.ContactID, c.FName, c.LName, c.IsActive)
		}
	}
	fmt.Println("=================================")
	...
	staff.CreateContactDetailByContactId(1, "ecwcw no.", "9834985338")
	staff.CreateContactDetailByContactId(2, "exwx no.", "9834985338")
	staff.CreateContactDetailByContactId(2, "ewecw no.", "9834985338")
	...
	// contactDetails := staff.GetAllContactDeatailsOfUser()
	// fmt.Println("===== All Contact Details of Specific Users =====")
